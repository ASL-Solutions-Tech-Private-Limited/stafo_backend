...
@section('title', 'Create Role & Permissions | STAFO HRMS')
...
@section('content')
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom">
                <div>
                    <h3 class="fw-bold text-dark mb-1">
                        <i class="fa-solid fa-plus-circle text-primary me-2"></i>Create Access Role
                    </h3>
                    <p class="text-muted small mb-0">Define an employee access role and select granted module permissions</p>
                </div>
            ...
            <!-- Form -->
            <form action="{{ route('company-roles.store') }}" method="POST" id="roleForm">
                @csrf
                ...
                <div class="row g-4 mb-4 pb-4 border-bottom">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('name') }}" 
                               placeholder="e.g. Field Executive, Team Lead, HR Manager, Sales Rep" 
                               required 
                               autofocus>
                        @error('name')
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" 
                                  ...
                                  placeholder="Describe the authority and organizational scope of this role...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="d-flex align-items-center gap-2 pt-3 border-top">
                    <button type="submit" class="btn btn-primary px-4 py-2.5 fw-semibold">
                        <i class="fa-solid fa-circle-check me-1"></i> Save & Create Role
                    </button>
