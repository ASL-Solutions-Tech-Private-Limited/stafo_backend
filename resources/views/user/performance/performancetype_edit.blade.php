...
@section('title', 'Edit Performance KPI Type | STAFO HRMS')
...
<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        ...
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4 pb-3 border-bottom">
            <div>
                <h3 class="fw-bold text-dark mb-1">Edit Performance Type</h3>
                <p class="text-muted small mb-0">Update KPI title and scoring guidelines</p>
            </div>
            ...
            <div class="row g-3">
                <div class="col-12 col-md-8">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $Performancetype->name) }}" required>
                        @error('name')
                ...
                <div class="col-12 col-md-8">
                    <div class="form-group mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="3">{{ old('description', $Performancetype->description) }}</textarea>
                        @error('description')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-12 col-md-8 d-flex justify-content-end align-items-center gap-2 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-primary px-5 fw-bold">
                        <i class="fa-solid fa-floppy-disk me-1"></i> Update KPI
                    </button>
                </div>
            </div>
        </form>
