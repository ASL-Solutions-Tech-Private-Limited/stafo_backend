        ...
        <div>
            <div class="row mb-3">
                ...
                <div class="col-md-3 col-6 text-end">
                    <a href="{{ route('leadFollowupCreate',$lead->id) }}" class="btn btn-success shadow-sm"><i class="fas fa-plus"></i>
                        Create New</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($followups as $index => $followup)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('followupEdit', $followup->id) }}" class="btn btn-warning btn-sm"><i
