...
@section('title', 'Employee Location') <!-- Set your custom title here -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-6 mb-9">
                    <h2 class="fw-bold mb-3">{{ $employee->name}}'s Location</h2>
                </div>
...
<script>
     ...
     $('#filterBtn').on('click', function() {
            var date = $('#date').val();
            if (date) {
                window.location.href = "{{ route('employee.location', ['id' => $employee->id]) }}?date=" + date;
            } else {
