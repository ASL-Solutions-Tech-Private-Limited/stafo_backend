...
@section('title', 'Create Expense Form | STAFO HRMS')
...
<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        ...
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4 pb-3 border-bottom">
            <div>
                <h3 class="fw-bold text-dark mb-1">Create Expense Form</h3>
                <p class="text-muted small mb-0">Define a new expense category and configure customizable submission fields</p>
            </div>
        ...
        <form action="{{ route('expenseformStore') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-3 bg-light rounded-4 border mb-4">
                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="e.g. Travel Reimbursement, Client Lunch" required>
                        @error('name')
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="3" placeholder="Enter instructions or spending policy limits for employees...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="d-flex justify-content-end align-items-center gap-2 pt-3 border-top">
                ...
                <button type="submit" class="btn btn-primary px-5 fw-bold">
                    <i class="fa-solid fa-floppy-disk me-1"></i> Save Expense Form
                </button>
            </div>
        </form>
    </div>
