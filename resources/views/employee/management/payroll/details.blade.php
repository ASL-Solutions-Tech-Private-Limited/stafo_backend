...
@section('title', 'Official Staff Payslip | Management Portal')
    ...
    <div class="card shadow-sm border-0 rounded-4 mb-4" style="background: var(--bs-card-bg, #ffffff);">
        <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom d-print-none">
                <a href="{{ route('employee.management.payroll.records', ['month' => $salarySummary->salary_month, 'year' => $salarySummary->salary_year]) }}" class="btn btn-outline-secondary px-3 py-2 rounded-3 fw-semibold">
                    <i class="fa-solid fa-arrow-left me-1"></i> Back to Payroll Register
                </a>
                <div class="d-flex align-items-center gap-2">
                    <button onclick="window.print()" class="btn btn-outline-primary px-3 py-2 rounded-3 fw-semibold">
                        <i class="fa-solid fa-print me-1"></i> Print Payslip
                    </button>
                    <a href="{{ route('employee.management.payroll.downloadSlip') }}?emp_id={{ $salarySummary->employee_id }}&month={{ $salarySummary->salary_month }}&year={{ $salarySummary->salary_year }}" class="btn btn-primary px-3 py-2 rounded-3 shadow-sm fw-semibold">
