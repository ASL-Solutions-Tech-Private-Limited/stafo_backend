            ...
            <td class="text-center">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.trips.show', $trip->id) }}">
                                <i class="fas fa-eye text-primary me-1"></i> View
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.trips.edit', $trip->id) }}">
                                <i class="fas fa-edit text-warning me-1"></i> Edit
                            </a>
                        </li>
                        <li>
                            <form action="{{ route('admin.trips.destroy', $trip->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                @csrf
                                @method('DELETE')
