...
<div class="container mt-4">
    ...
    <div class="col-md-6">
        ...
        <div class="mt-5">
            ...
            <form action="{{ route('admin.trips.assign', $trip->id) }}" method="POST" class="row g-3">
                @csrf
                @method('PUT')
            <!-- Vehicle Dropdown -->
            <div class="col-md-6">
...
{{-- <script>
    function checkVehicleAvailability() {
        ...
        const url = `{{ route('admin.trips.checkVehicleAvailability', ['trip' => '__trip__', 'vehicle' => '__vehicle__']) }}`.replace('__trip__', tripId).replace('__vehicle__', vehicleId);
    ...
    function checkDriverAvailability() {
        ...
        const url = `{{ route('admin.trips.checkDriverAvailability', ['trip' => '__trip__', 'driver' => '__driver__']) }}`.replace('__trip__', tripId).replace('__driver__', driverId);
...
<script>
    ...
    function checkVehicleAvailability() {
        ...
        const url = `{{ route('admin.trips.checkVehicleAvailability', ['trip' => '__trip__', 'vehicle' => '__vehicle__']) }}`
    ...
    function checkDriverAvailability() {
        ...
        const url = `{{ route('admin.trips.checkDriverAvailability', ['trip' => '__trip__', 'driver' => '__driver__']) }}`
            .replace('__trip__', tripId)
