                ...
                <div class="new-user-form mt-4 p-4">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="fname" id="company" class="form-control fname"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="lname" id="company" class="form-control lname"
                        ...
                        <div class="d-flex justify-content-end gap-2"><a href="{{ route('users.index') }}"><button
                                    type="button" class="btn bg-secondary text-white">Cancel</button></a><button
                                class="btn btn-primary text-white submit" type="submit">Save</button></div>
