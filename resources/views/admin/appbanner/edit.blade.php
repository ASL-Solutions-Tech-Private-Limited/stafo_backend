...
@section('content')
    <div class="app-main__outer">
        ...
        <div class="app-main__inner">
            ...
            <form action="{{ route('appbanner.update', $appbanner->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT') 
               <div class="new-user-form">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            @if($appbanner->image)
                                <div class="mt-2">
                                    <img src="{{ asset('uploads/appbanner/' . $appbanner->image) }}" alt="Current Image" width="100">
                                </div>
                            @endif
