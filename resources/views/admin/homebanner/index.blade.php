    ...
    <div class="app-main__outer">
        ...
        <div class="app-main__inner">
            <div class="d-flex justify-content-between user-access">
                ...
                <a href="{{ route('homebanner.create') }}" class="btn d-flex align-items-center btn-primary">
                        Add
                </a>
            </div>
                                        ...
                                        @foreach ($data as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($item->image)
                                                        <div>
                                                            <img src="{{ asset('uploads/homebanner/' . $item->image) }}"
                                                ...
                                                <td>
                                                    <div class="actions">
                                                        ...
                                                        <a class="edit" href="{{ route('homebanner.edit', $item->id) }}"><i
                                                                class="fa fa-solid fa-pen"></i></a>
                                                        <form method="POST" style="all:unset;"
                                                            action="{{ route('homebanner.destroy', $item->id) }}">
                                                            @csrf
