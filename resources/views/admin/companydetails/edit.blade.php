    ...
    <div class="app-main__outer">
        ...
        <div class="app-main__inner">
            ...
            <form action="{{ route('company.details.update', $company->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="new-user-form mt-2 py-3">
                    <div class="row">
                            ...
                            <select name="company_type" id="company_type" class="form-control">
                                ...
                                @foreach ($companytypes as $companytype)
                                    <option value="{{ $companytype->id }}"
                                        {{ old('company_type', $company->company_type) == $companytype->id ? 'selected' : '' }}>
                            ...
                            <select name="business_type_id" id="business_type_id" class="form-control">
                                ...
                                @foreach ($business_types as $business_type)
                                    <option value="{{ $business_type->id }}"
                                        {{ old('business_type_id', $company->business_type_id) == $business_type->id ? 'selected' : '' }}>
                        ...
                        <!-- Company Name -->
                        <div class="col-md-4 mb-3">
                            <label for="company_name" class="text-dark">Company Name<span class="red">*</span></label>
                        ...
                        <!-- Account Number -->
                        <div class="col-md-4 mb-3">
                            <label for="account_number" class="text-dark">Account Number<span
                        ...
                        <!-- No of Employees -->
                        <div class="col-md-4 mb-3">
                            <label for="no_of_employee" class="text-dark">Number of Employees<span
                                    class="red">*</span></label>
                        ...
                        <!-- No of Employees can be added -->
                        <div class="col-md-4 mb-3">
                            <label for="max_employee_add" class="text-dark">Max Number of Employees Add<span
                                    class="red">*</span></label>
                            <input type="number" name="max_employee_add" id="max_employee_add" class="form-control"
                                value="{{ old('max_employee_add', $company->max_employee_add) }}"
                                placeholder="Enter Max Number of Employees Can Be Added">
                            @error('max_employee_add')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>

                        <div class="col-md-4 mb-3">
                            <label for="subscription_start" class="text-dark">Subscription Start date<span
                                    class="red">*</span></label>
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="subscription_end" class="text-dark">Subscription Start date<span
                                    class="red">*</span></label>
                            <input type="date" name="subscription_end" id="subscription_end" class="form-control"
                                value="{{ old('subscription_end', $company->subscription_end) }}"
                                placeholder="Subscription Start Date">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="map_view" class="text-dark">Map View</label>
                            <select name="map_view" id="map_view" class="form-control">
                                <option value="GoogleMap" {{ old('map_view', $company->map_view) == 'GoogleMap' ? 'selected' : '' }}>
                                    GoogleMap</option>
                                <option value="MapMyIndia" {{ old('map_view', $company->map_view) == 'MapMyIndia' ? 'selected' : '' }}>
                                    MapMyIndia</option>
                            </select>
                            @error('map_view')
                                <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="owner_email" class="form-control"
                                        value="{{ isset($proprietor->email) ? $proprietor->email : '' }}"
