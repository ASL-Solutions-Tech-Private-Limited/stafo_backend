...
@section('content')
    <div class="container mt-4">
        ...
        <form action="{{ route('branches.update', $branch->id) }}" method="POST">
            @csrf
            @method('PUT') <!-- Since it's an update request, we need the PUT method -->
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="branch_address" class="form-control @error('branch_address') is-invalid @enderror" rows="4"
                        placeholder="Enter Branch Address">{{ old('branch_address', $branch->branch_address) }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="latitude" class="form-control @error('latitude') is-invalid @enderror"
                        value="{{ old('latitude', $branch->latitude) }}" placeholder="Enter Latitude">
                    @error('latitude')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="longitude" class="form-control @error('longitude') is-invalid @enderror"
                        value="{{ old('longitude', $branch->longitude) }}" placeholder="Enter Longitude">
                    @error('longitude')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="radar" class="form-control @error('radar') is-invalid @enderror"
                        value="{{ old('radar', $branch->radar) }}" placeholder="Enter Radar">
                    @error('radar')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
