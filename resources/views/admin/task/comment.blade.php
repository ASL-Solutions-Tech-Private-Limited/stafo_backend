        ...
        <div>
            <div class="row mb-3">
                ...
                <div class="col-md-3 col-6 text-end">
                    <a href="{{ route('admin.commentCreate',$task->id) }}" class="btn btn-success shadow-sm"><i class="fas fa-plus"></i>
                        Create New</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($comments as $index => $comment)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.commentEdit', $comment->id) }}" class="btn btn-warning btn-sm"><i
                                            class="fas fa-edit"></i></a>

                                    <!-- Delete Form with Confirmation -->
                                    <form id="delete-form-{{ $comment->id }}"
                                        action="{{ route('admin.commentDelete', $comment->id) }}" method="POST"
