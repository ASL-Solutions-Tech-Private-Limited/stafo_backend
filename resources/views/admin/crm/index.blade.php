        ...
        <div>
            <div class="row mb-3">
                ...
                <div class="col-md-3 col-6 text-end">
                    <a href="{{ route('admin.leadCreate',$companyId) }}" class="btn btn-success shadow-sm"><i class="fas fa-plus"></i>
                        Create New</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($leads as $index => $lead)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.leadEdit', $lead->id) }}" class="btn btn-warning btn-sm"><i
                                            class="fas fa-edit"></i></a>
                                    <a href="{{ route('admin.leadFollowup', $lead->id) }}" class="btn btn-primary btn-sm"><i
                                            class="fas fa-plus"></i></a>

                                    <!-- Delete Form with Confirmation -->
                                    <form id="delete-form-{{ $lead->id }}"
                                        action="{{ route('admin.leadDelete', $lead->id) }}" method="POST"
