...
<div class="card mt-4 p-3">
    ...
    <!-- Search Form -->
    <form method="GET" action="{{ route('admin.vehicles.index') }}" class="row g-3 mb-3">
        <div class="col-md-4">
            <input
                type="text"
                name="vehicle_no"
        ...
        <div class="col-md-4">
            ...
            <a href="{{ route('admin.vehicles.index') }}" class="btn btn-secondary">Reset</a>
        </div>
    </form>
            ...
            <tbody>
                @forelse($vehicles as $index => $vehicle)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.vehicles.edit', $vehicle->id) }}" class="btn btn-sm btn-primary" title="Edit">
                            ...
                            <form id="delete-form-{{ $vehicle->id }}" action="{{ route('admin.vehicles.destroy', $vehicle->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-sm btn-danger" title="Delete" onclick="confirmDelete(event, {{ $vehicle->id }})">
                                <i class="fa fa-trash"></i>
