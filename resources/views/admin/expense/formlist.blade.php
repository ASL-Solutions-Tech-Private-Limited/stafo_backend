    ...
    <div class="card mt-4 p-3 shadow-sm border-0">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3 col-6 text-end">
                <a href="{{ route('admin.expenseformCreate') }}" class="btn btn-success shadow-sm"><i class="fas fa-plus"></i>
                    Create</a>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    @foreach ($expenseforms as $index => $form)
                        <tr>
                            ...
                            <!-- Actions -->
                            <td>
                                <a href="{{ route('admin.expenseformDetails', $form->id) }}" class="btn btn-info btn-sm"><i
                                        class="fas fa-eye"></i></a>
                                <a href="{{ route('admin.expenseformEdit', $form->id) }}" class="btn btn-warning btn-sm"><i
                                        class="fas fa-edit"></i></a>
                                <form action="{{ route('admin.expenseformDelete', $form->id) }}" method="POST"
    ...
    {{-- <script>
        ...
        document.querySelectorAll('.clickable-status').forEach(status => {
            status.addEventListener('click', function () {
                ...
                let toggleStatusUrl = '{{ route('admin.expensestatuschange', ':id') }}';
